<x-app-layout>
    ...
    <div class="flex justify-start">
        <a href={{ route('dashboard.create') }}><button class="mx-4 my-5 py-3 px-5 rounded bg-green-400">New
                Book</button></a>
    </div>
    <div class="pt-3 mx-4">
        ...
        <table class="table-auto w-full text-sm text-left rtl:text-right py-10">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b">
                    ...
                    <td>{{$book->quantity}}</td>
                    <td class="text-center"><a href={{route('dashboard.show',['dashboard'=> $book->id])}} class="p-2
                            px-4
